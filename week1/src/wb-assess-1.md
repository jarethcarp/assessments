...
```
console.log will out put to the console and return outputs to the called function
```

**_What's the difference between defining and calling a function?_**

```
Defining is setting up what the function can do and calling a function will invoke or run the function
```
...
```
number values that range from thiings like 0.837 to -76 to 59204
```
...
```
An array is a series of values groupped together
```
